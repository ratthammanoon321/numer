    ...
    getValue = ()=>{
      ...
      EquationBisection = () =>{
        ...
        const config = {
          ...
          // axios.post('http://localhost/Numer/server/add.php',formData,config)
        axios.post('http://localhost/Numer/server/add.php',formData,config)
        .then(res=>{
          console.log(res);
        })
      ...
      render() {
        return (
          ...
          <Layout style={{ minHeight: '100vh' }}>
            ...
            <Button onClick={this.EquationBisection}>ADDDATA</Button></center>
            </div>
